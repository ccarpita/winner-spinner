...
export default class TextInput extends Element {
  private _focussed: boolean;
  private _value: any;
  private _emitter: Emitter 
  private _input: HTMLInputElement | null = null
  private _inputPrevColor: string = ""
  ...
  normalizeInput(inputStr: string): any {
  ...
  createInputElement(): HTMLInputElement {
    return this.createElement('input') as HTMLInputElement;
  }
